...
1. Create or upgrade the FMP account and complete the appropriate written public-display agreement. Do not paste the API key into chat, a source file, an issue, or a commit.
